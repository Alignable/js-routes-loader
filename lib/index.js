...
function RoutesLoader(source) {
  ...
  var options = Object.assign({}, { fetch: './simpleFetch' }, _loaderUtils2.default.getOptions(this));

  var routePath = _loaderUtils2.default.stringifyRequest(this, '' + require.resolve('./Route.js'));
  var fetchWrapperPath = _loaderUtils2.default.stringifyRequest(this, '!' + require.resolve(options.fetch));
